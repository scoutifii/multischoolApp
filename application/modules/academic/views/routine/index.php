...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">
  ...
  $('#edit_end_time').timepicker();
    ...
    <?php if(isset($edit)){ ?>
        get_section_subject_by_class('<?php echo $routine->class_id; ?>', '<?php echo $routine->section_id; ?>', '<?php echo $routine->subject_id; ?>', '<?php echo $routine->teacher_id; ?>');
    <?php } ?>
    
    
    function get_section_subject_by_class(class_id, section_id, subject_id, teacher_id){       
