...
/*switch($_SERVER["SERVER_NAME"]) {
 case "localhost":
 $config["base_url"] = "http://127.0.0.1/multischool/";
 break;
 case "kencareinvests.shop":
 $config["base_url"] = "http://www.kencareinvests.shop/";
 break;
}
...
define('SMS', 'Schoolify - Multi School Management System');
define('FROM_EMAIL', 'info@kencareinvestltd.com');
define('FROM_NAME', 'Schoolify Multi School');