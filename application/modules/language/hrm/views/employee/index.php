                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="<?php echo $password; ?>" placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">
