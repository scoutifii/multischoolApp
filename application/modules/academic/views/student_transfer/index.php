<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-mail-forward"></i><small> <?php echo $this->lang->line('manage_student_transfer'); ?></small></h3>
            ...
            <div class="x_content">                 
                <?php echo form_open_multipart(site_url('academic/studenttransfer/index'), array('name' => 'transfer', 'id' => 'transfer', 'class' => 'form-horizontal form-label-left'), ''); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <div><?php echo $this->lang->line('next_class'); ?> <span class="required">*</span></div>
           ...
           <?php  if (isset($students) && !empty($students)) { ?>
            <div class="x_content">             
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4 layout-box">
                        <p>
                            <h4><?php echo $this->lang->line('student_transfer'); ?></h4>                        
                        </p>
                    </div>
                </div>            
            </div>
            ...
            <div class="x_content">
                 <?php echo form_open(site_url('academic/studenttransfer/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                        ...
                        if (isset($students) && !empty($students)) { ?>
                            ...
                            <?php  $position = get_position_in_class($school_id, $academic_year_id, $current_class_id, $obj->id); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select  class="form-control col-md-7 col-xs-12" name="student_transfer_class_id[<?php echo $obj->id; ?>]"  required="required">                                
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-5">
                        <?php  if (isset($students) && !empty($students)) { ?>
                         ...
                         <input type="hidden" value="<?php echo $next_class_id; ?>" name="next_class_id"/>       <input type="hidden" value="<?php echo $next_session_id; ?>" name="next_session_id"/>
                         
                         <a href="<?php echo site_url('academic/studenttransfer'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                         <?php if(has_permission(ADD, 'academic', 'studenttransfer')){ ?>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $('#school_id').on('change', function(){
        ...
        get_current_class_by_school(school_id, class_id); 
...
<script type="text/javascript">
    $("document").ready(function() {
         <?php if(isset($school_id) && !empty($school_id)){ ?>               
            $("#next_school_id").trigger('change');
         <?php } ?>
    });
    
    $('#next_school_id').on('change', function(){
