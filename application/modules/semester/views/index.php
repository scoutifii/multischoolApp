                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(isset($detail)){ ?>
                            ...
                            <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="<?php echo site_url('student/index'); ?>"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('student'); ?></a> </li>
                            ...
                            <li  class="active"><a href="#tab_view_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('view'); ?> <?php echo $this->lang->line('student'); ?></a> </li>                          
                                                ...
                                                <?php } ?>
                                                 <?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                                    <select  class="form-control col-md-7 col-xs-12 status-type"  name="status_type"  id="status_type" onchange="update_status_type('<?php echo $obj->id; ?>', this.value);">
                                                        ...
                                                        <option value="drop" <?php echo $obj->status_type == 'drop_out' ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line('drop_out'); ?></option>
                            ...
                            <div class="x_content"> 
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                    <label for="student_no"><?php echo $this->lang->line('student_no'); ?> <span class="required">*</span></label>                                    
                                        <input  class="form-control col-md-7 col-xs-12"  name="custom_id"  id="custom_id" value="<?php echo $custom_id; ?>" readonly="readonly" placeholder="<?php echo $this->lang->line('student_no'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('student_no'); ?></div>                     
                                </div>
                                </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_no"  id="registration_no" value="<?php echo $custom_id; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>" type="text" autocomplete="off" readonly>
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select  class="form-control col-md-7 col-xs-12" name="gud_religion" id="gud_religion">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $religions = get_religion(); ?>
                                                <?php foreach($religions as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php echo isset($post['gud_religion']) && $post['gud_religion'] == $key ?  'selected="selected"' : ''; ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                                </select>
