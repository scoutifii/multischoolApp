    ...
    <label class="control-label" for="sub_county_id"><?php echo $this->lang->line('subcounty'); ?> <?php echo $this->lang->line('name'); ?><span class="required" >*</span></label>
        ...
        <select  class="form-control fn_subcounty_id" name="sub_county_id" id="edit_sub_county_id" required="required">
            ...
            <?php foreach($subcounties as $obj){ ?>
                <option value="<?php echo $obj->id; ?>" <?php if($school->sub_county_id == $obj->id ) { echo 'selected="selected"'; } ?>><?php echo $obj->sub_county_name; ?></option>
            <?php } ?>
        </select>
    </div>
...
<?php }else{ ?>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input class="fn_subcounty_id" type="hidden" name="sub_county_id" id="edit_sub_county_id" value="<?php echo $this->session->userdata('sub_county_id'); ?>" />
        </div>
    </div>
<?php } ?>
