                        ...
                        <div  class="tab-pane fade in <?php if(isset($single)){ echo 'active'; }?>" id="tab_single_invoice">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/invoice/add'), array('name' => 'single', 'id' => 'single', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <!--div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="paid"><?php echo $this->lang->line('paid'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="paid"  id="paid" value="<?php echo isset($post['paid']) ?  $post['paid'] : '0.00'; ?>" placeholder="<?php echo $this->lang->line('paid'); ?>" required="required" type="text" autocomplete="off">
