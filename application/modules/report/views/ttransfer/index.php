<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('teacher_transfer_report'); ?></small></h3>                
            ...
            <?php $this->load->view('quick_report'); ?>   
             ...
             <div class="x_content filter-box no-print"> 
                <?php echo form_open_multipart(site_url('report/teachertransfer'), array('name' => 'transfer', 'id' => 'transfer', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">                    
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in active" id="tab_graphical" >
                            <div class="x_content">
                                 ...
                                 <script type="text/javascript">
                                    ...
                                    $(function () {
                                        $('#teachers-report').highcharts({
                                            ...
                                            title: {
                                                text: ' <?php echo $this->lang->line('teacher_transfer_report'); ?>'
                                            },
                                            subtitle: {
                                                text: ''
                                            },
                                ...
                                <div id="teachers-report" style="width: 99%; height: 500px; margin: 0 auto"></div>
                                 <?php }else{ ?>
