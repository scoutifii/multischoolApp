        ...
        <div class="x_panel">
            ...
            <div class="x_content print_area"> 
                <div class="profile_img">
                    <div class="container">
                        ...
                        <div class="row">     
                            ...
                            <div class="col-sm-6">
                              <div class="col-padding">
                                <h5 class="text-uppercase" style="color: #000000; text-align: center;">Termly Assessment Report</h5>
                                <div class="text-center">
                                    <div class="row"><?php echo $this->lang->line('name'); ?> : <?php echo $student->name; ?></div>
                                    <div class="row">
                                        <br/>
                                        <?php echo $this->lang->line('class'); ?> : <?php echo $student->class_name; ?>,
                                        <?php echo $this->lang->line('section'); ?> : <?php echo $student->section; ?>,
                                        <?php echo $this->lang->line('admission_no'); ?> : <?php echo $student->admission_no; ?>,
                                        <?php echo $this->lang->line('gender'); ?> : <?php echo $student->gender; ?><br>
             ...
             <?php } ?>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>                           
                                ...
                                <th>Remarks and Generic Skills</th>
                ...
                <div class="row">
                    <table id="datatable-responsive" class="table table-striped table-bordered" width="25%">
                        <thead>
                            <tr>
                                <th colspan="3">KEY WORDS AND DEFINITION OF TERMS</th>
                            </tr>
                            <tr>
                                <th>Identifier</th>
                                <th>Score Range</th>
                        ...
                        <tbody>
                            <?php foreach($score_range as $obj){ ?> 
                            <tr>
                                <td width="10%"><?php echo $obj->identifier; ?></td>
                                <td width="10%"><?php echo $obj->score_range; ?></td>
                                <td width="10%"><?php echo $obj->descriptor; ?></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
