                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php }else{ ?> 
                            ...
                            <?php if(has_permission(ADD, 'student', 'student')){ ?>
                                <?php if(isset($edit)){ ?>
                                    <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('student/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('student'); ?></a> </a> </li>                          
                                 <?php }else{ ?>
                                     <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('student'); ?></a> </a> </li>                          
                                 <?php } ?>
                            <?php } ?>
                                                ...
                                                <?php } ?>
                                                 <?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                                    <select  class="form-control col-md-7 col-xs-12 status-type"  name="status_type"  id="status_type" onchange="update_status_type('<?php echo $obj->id; ?>', this.value);">
                                                        ...
                                                        <option value="transferred" <?php echo $obj->status_type == 'transferred' ?  'selected="selected"' : ''; ?>><?php echo $this->lang->line('transferred'); ?></option>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="admission_no"  id="admission_no" value="<?php echo $custom_id; ?>" placeholder="<?php echo $this->lang->line('admission_no'); ?>" required="required" type="text" autocomplete="off" readonly="readonly">
                                         ...
                                         <div class="item form-group">
                                              ...
                                              <select  class="form-control col-md-7 col-xs-12" name="religion" id="religion">
                                                ...
                                                <?php foreach($religions as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php echo isset($post['religion']) && $post['religion'] == $key ?  'selected="selected"' : ''; ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                                </select>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="child_with_disabilities"><?php echo $this->lang->line('disabled'); ?><span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="child_with_disabilities" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="yes" <?php if(isset($post) && $post['yes'] == 'yes'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="no" <?php if(isset($post) && $post['no'] == 'no'){ echo 'selected="selected"';} ?>><?php echo $this->lang->line('no'); ?></option>
                                                
                                            </select>
                                            <div class="help-block"><?php echo form_error('child_with_disabilities'); ?></div> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row"> 
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="registration_no"><?php echo $this->lang->line('registration_no'); ?><span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_no"  id="registration_no" value="<?php echo isset($post['registration_no']) ?  $post['registration_no'] : ''; ?>" placeholder="<?php echo $this->lang->line('registration_no'); ?>" type="text" autocomplete="off" required="required">
                                            <div class="text-info"><?php echo $this->lang->line('valid_reg_format_no'); ?></div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="<?php echo $password ?>" placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off" readonly="readonly">
                                 ...
                                 <!--div class="col-md-3 col-sm-3 col-xs-12">
                                     <div class="item form-group">
                                        <label for="finger_print_capture"><?php echo $this->lang->line('finger_print_capture'); ?> </label>
                                        <table>
                                            <tr>
                                                <td class="col-md-6 col-md-offset-3">
                                                    <img id="finger" width="100px" height="80px">
                                                </td>
                                                <td class="col-md-6 col-md-offset-3">
                                                    <button type="submit" name="finger_capture" id="finger_capture" class="btn btn-success" onclick="return Capture()"><?php echo $this->lang->line('capture'); ?></button>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="help-block"><?php echo form_error('finger_print_capture'); ?></div>
                                     </div>
                                 </div-->
                            </div>
                             <div class="row">                                     
                               ...
                               <div class="row">                  
                                ...
                                <div class="row">                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="admission_no"><?php echo $this->lang->line('admission_no'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="admission_no"  id="admission_no" value="<?php echo isset($student->admission_no) ?  $student->admission_no : ''; ?>" placeholder="<?php echo $this->lang->line('admission_no'); ?>" readonly="readonly" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('admission_no'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         ...
                                         <div class="item form-group">
                                              <label for="religion"><?php echo $this->lang->line('religion'); ?></label>
                                               <select  class="form-control col-md-7 col-xs-12" name="religion" id="religion">
                                                ...
                                                <?php $religions = get_religion(); ?>
                                                <?php foreach($religions as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php if ($student->religion == $key) {
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="child_with_disabilities" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <option value="yes" <?php echo $student->child_with_disabilities == 'yes' ? 'selected="selected"' : ''; ?>><?php echo $this->lang->line('yes'); ?></option>
                                                <option value="no" <?php echo $student->child_with_disabilities == 'no' ? 'selected="selected"' : ''; ?>><?php echo $this->lang->line('no'); ?></option>
...
<script type="text/javascript">
    function Capture() {
            try {
                ...
                document.getElementById('finger').src = "data:image/bmp;base64,";
                ...
                if (res.httpStaus) {
                    ...
                    if (res.data.ErrorCode == "0") {
                        document.getElementById('finger').src = "data:image/bmp;base64," + res.data.BitmapData;
