...
<?php if(has_permission(VIEW, 'student', 'student')){ ?>
 ...
 <?php if(has_permission(VIEW, 'guardian', 'guardian')){ ?>
   | <a href="<?php echo site_url('guardian/index'); ?>"><?php echo $this->lang->line('manage_guardian'); ?></a>                    
 <?php } ?>
<?php if(has_permission(ADD, 'student', 'student')){ ?>
   | <a href="<?php echo site_url('student/index'); ?>"><?php echo $this->lang->line('admit_student'); ?></a>
 <?php } ?>   
