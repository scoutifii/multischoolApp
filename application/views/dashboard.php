...
<div class="content-wrapper">
    <section class="content-header">
        <h3>
            <i class="fa fa-dashboard" style="color: #000"></i> <?php echo $this->lang->line('dashboard'); ?></h3>
    </section>
<!-- top tiles -->
                    ...
                    $(function () {
                       $('#school-stats').highcharts({
                                chart: {
                                    ...
                                    xAxis: {
                                        categories: ['<strong><?php echo $this->lang->line('school'); ?></strong>', '<strong><?php echo $this->lang->line('class_rooms'); ?></strong>', '<strong><?php echo $this->lang->line('class_room_blocks'); ?></strong>','<strong><?php echo $this->lang->line('play_ground'); ?></strong>', '<strong><?php echo $this->lang->line('toilets'); ?></strong>','<strong><?php echo $this->lang->line('disabled_student'); ?></strong>', '<strong><?php echo $this->lang->line('text_book'); ?></strong>','<strong><?php echo $this->lang->line('library'); ?></strong>', '<strong><?php echo $this->lang->line('laboratory'); ?></strong>', '<strong><?php echo $this->lang->line('day_and_boarding'); ?></strong>','<strong><?php echo $this->lang->line('primary_school'); ?></strong>','<strong><?php echo $this->lang->line('teacher_quarters'); ?></strong>']
                                    },
                                    yAxis: {
                                        min: 0,
                                        title: {
         ...
         <div class="col-md-3 col-sm-3 col-xs-12">
          ...
          <div class="info-box bg-green">
            ...
            <div class="info-box-content"></div>
              <span class="info-box-text">ALL SCHOOLS: <?php echo $total_schools ? $total_schools : 0; ?></span>
              </a>
              <div class="progress">
                <div class="progress-bar" style="width: 50%"></div>
                 <span class="info-box-text">Total students: <?php echo $total_student ? $total_student : 0; ?></span>
              </div>
...
<?php } ?> 
        ...
        <!--div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    <ul  class="list-unstyled msg_list">
                        <?php if(isset($active_logins) && !empty($active_logins)){ ?>
                            <?php foreach($active_logins as $obj ){ ?>
                            <li>
                                <a href="<?php echo site_url('announcement/notice/view/'.$obj->id); ?>">
        ...
        <!--div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 class="head-title"><?php echo $this->lang->line('active'); ?> <?php echo $this->lang->line('user'); ?></h4>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> </li>
                        </ul>
                        <div class="clearfix"></div>
                    ...
                    <div class="x_content">
                                ...
                                $('#active-logins').highcharts({
                                    ...
                                    series: [{
                                            ...
                                            data: [
                                                <?php if(isset($active_logins) && !empty($active_logins)){ ?>
                                                    <?php foreach($active_logins as $obj){ ?>
                                                    ['<?php echo $obj->username; ?>', <?php echo $obj->total_user; ?>],
                                                    <?php } ?>
                                                <?php } ?>
                                            ]
                                        }]
                        ...
                        <div id="active-logins" style=" width: 100%; vertical-align: top; height:260px; "></div>
                    </div>
                </div>
            </div-->
    </div>
