<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user-md"></i><small> <?php echo $this->lang->line('manage_district_admin'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_district_admin_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        
                        <?php if(has_permission(ADD, 'hrm', 'employee')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('administrator/districtadmin/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('district_admin'); ?></a> </li>                          
                             <?php }else{ ?>
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'districtadmin')){ ?> 
                                                    <a href="<?php echo site_url('administrator/districtadmin/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a><br/>
                                                <?php } ?> 
                                                ...
                                                <?php if(has_permission(DELETE, 'administrator', 'districtadmin')){ ?> 
                                                    <?php if(!$obj->is_default){ ?> 
                                                        <a href="<?php echo site_url('administrator/districtadmin/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                        </tr>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_district_admin">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/districtadmin/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/district_list_form'); ?> 
                                <div class="row">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="<?php echo $password; ?>" placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off" readonly>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('administrator/districtadmin/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_district_admin">
                            <div class="x_content"> 
                            <?php echo form_open_multipart(site_url('administrator/districtadmin/edit/'. $districtadmin->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="religion" id="religion">
                                                ...
                                                <?php $religions = get_religion(); ?>
                                                <?php foreach($religions as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php if($districtadmin->religion == $key){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                        <div class="help-block"><?php echo form_error('religion'); ?></div> 
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            <label for="present_address"><?php echo $this->lang->line('present_address'); ?> </label>
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="present_address"  id="present_address" placeholder="<?php echo $this->lang->line('present_address'); ?>"><?php echo isset($districtadmin->present_address) ?  $districtadmin->present_address : ''; ?></textarea>
                                            <div class="help-block"><?php echo form_error('present_address'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="permanent_address"><?php echo $this->lang->line('permanent_address'); ?></label>
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="permanent_address"  id="permanent_address"  placeholder="<?php echo $this->lang->line('permanent_address'); ?>"><?php echo isset($districtadmin->permanent_address) ?  $districtadmin->permanent_address : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('permanent_address'); ?></div>
                                        </div>
                                    </div>
...
<div class="modal fade bs-district_admin-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body fn_district_admin_data">            
        </div>       
      </div>
    </div>
</div>
<script type="text/javascript">
    ...
    function get_district_admin_modal(district_admin_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('administrator/districtadmin/get_single_district_admin'); ?>",
          data   : {district_admin_id : district_admin_id},  
          success: function(response){                                                   
             if(response)
             {
                $('.fn_district_admin_data').html(response);
             }
          }
       });
    }
