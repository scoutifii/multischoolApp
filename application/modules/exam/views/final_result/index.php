<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content"> 
                <?php echo form_open_multipart(site_url('exam/finalresult/index'), array('name' => 'mark', 'id' => 'mark', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
 ...
 <script type="text/javascript">     
  ...
  $(document).ready(function(){
       ...
       $('.fn_mark_total').keyup(function(){         
          ...
          const avg = $('#avg_score_'+student_id).val(avgMark([written_mark,written_obtain,tutorial_mark,tutorial_obtain]).toFixed(1)) ? parseFloat($('#avg_score_'+student_id).val()) : 0;
          const grade = (avg/3*20).toFixed(1);
          
          var out_of_20 = $('#out_of_20_'+student_id).val(grade) ? parseInt($('#out_of_20_'+student_id).val()) : 0;
