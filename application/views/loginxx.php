        ...
        <div class="login_wrapper">
            <section>
                <center>
                    ...
                    <?php }else{ ?>
                        <img  width="100" height="100" src="<?php echo IMG_URL; ?>/olify.png">
                    <?php } ?>                    
                </center>
            </section>
            <div class="form login_form">
                <section><h1 class="text-center"><i class="fa fa-university"> <?php echo $this->lang->line('login'); ?></h1></i></section>    
