    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $this->data['students'] = $this->mark->get_student_list($school_id, $exam_id, $class_id, $section_id, $subject_id, $school->academic_year_id, $term_id);
        ...
        if ($_POST) {
            ...
            if (!empty($_POST['students'])) {
                ...
                foreach ($_POST['students'] as $key => $value) {
                    ...
                    $data['cummulative_mark1'] = $_POST['cummulative_mark1'][$value];
                    $data['cummulative_mark2'] = $_POST['cummulative_mark2'][$value];
                    $data['cummulative_mark3'] = $_POST['cummulative_mark3'][$value];
                    $data['cummulative_mark4'] = $_POST['cummulative_mark4'][$value];
                    $data['cummulative_mark5'] = $_POST['cummulative_mark5'][$value];
                    $data['cummulative_mark6'] = $_POST['cummulative_mark6'][$value];
