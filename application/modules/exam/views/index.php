                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="term_id"  id="add_term_id" >
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/edit/'.$exam->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="term_id"  id="edit_term_id">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($terms as $obj ){ ?>
                                            <option value="<?php echo $obj->id; ?>" <?php if($exam->term_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('term_id'); ?></div>
                                    </div>
